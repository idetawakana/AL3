...
void Determinant(WorldTransform worldtransform,Vector3 scale, Vector3 rotation, Vector3 translation);
...
void GameScene::Initialize() {
	...
	for (WorldTransform& worldtransform : worldtransforms_) {
		...
		//worldtransform = Determinant(worldtransform.scale_, worldtransform.rotation_, worldtransform.translation_);

		//worldtransform.TransferMatrix();

		Determinant(worldtransform, { 0,0,0 }, { angle(angleEngine),angle(angleEngine) ,angle(angleEngine) }, { trans(transEngine),trans(transEngine),trans(transEngine) });
	}
